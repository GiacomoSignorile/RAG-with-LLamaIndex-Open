...
def custom_chunker(text, max_length=1024, chunk_overlap=0, remove_table_tags=True, table_descr=True):
    '''
    ...
    for start, end in table_positions:
        ...
        pre_table_text = text[max(0, last_pos - chunk_overlap):start]  
    ...
    remaining_text = text[max(0, last_pos - chunk_overlap):]  
...
def get_documents(path='./Docs', max_len=1024):
    ...
    for pdf_file in pdf_files:
        ...
        chunk_splitted = custom_chunker(all_text, max_length=max_len)

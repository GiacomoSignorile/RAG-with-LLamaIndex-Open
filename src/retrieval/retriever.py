...
def get_response_italian(query_str, query_engine):
    ...
    tmpl_str = (
    "Le informazioni contestuali sono qui sotto.\n"
    "---------------------\n"
    "{context_str}\n"
    "---------------------\n"
    "Dato il seguente contesto e non la conoscenza di base, "
    "rispondi alla seguente query in Italiano dagli esempi proposti sopra.\n"
    "Query: {query_str}\n"
    "Answer: "
    )
    ...
    {"response_synthesizer:text_qa_template": tmpl}
    )
